...
public class SignUp extends javax.swing.JFrame {
    ...
    try {
        ...
        if ("".equals(fullName)) {
            ...
            return; // Exit the method if full name is not provided
        ...
        if (!email.matches(emailRegex)) {
            JOptionPane.showMessageDialog(new JFrame(), "Enter a valid email address", "Error", JOptionPane.ERROR_MESSAGE);
            return; // Exit the method if email format is not valid
        }
        
        String checkQuery = "SELECT * FROM login WHERE email = '" + email + "'";
        ...
        if (rs.next()) {
            ...
            // Username does not exist, proceed with the sign-up process
            String insertQuery = "INSERT INTO login(full_name, email, password) VALUES('" + fullName + "', '" + email + "' , '" + password + "')";
            st.executeUpdate(insertQuery);
            JOptionPane.showMessageDialog(null, "New account has been created successfully!");

            // Reset text fields after successful signup
            fname.setText("");
